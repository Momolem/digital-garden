...
| [Open Closed Principle](docs/main/CleanCode/Open%20Closed%20Principle.md). You can introduce new strategies without having to change the context. | |

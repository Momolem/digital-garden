...
- Designs that make heavy use of Composite and [Decorator](/docs/main/CleanCode/DesignPatterns/Decorator) can often benefit from using [Prototype](docs/main/CleanCode/DesignPatterns/Prototype.md). Applying the pattern lets you clone complex structures instead of re-constructing them from scratch.

...
![cleancode9](//assets/cleancode9.webp)
...
|  _[Single Responsibility Principle](/docs/main/CleanCode/Single%20Responsibility%20Principle)_. You can move the product creation code into one place in the program, making the code easier to support. | |
| _[Open Closed Principle](/docs/main/CleanCode/Open%20Closed%20Principle)_. You can introduce new types of products into the program without breaking existing client code. |
## Relations with Other Patterns
- Many designs start by using Factory Method (less complicated and more customizable via subclasses) and evolve toward [Abstract Factory](/docs/main/CleanCode/Abstract%20Factory), [Prototype](docs/main/CleanCode/Prototype.md), or [Builder](docs/main/CleanCode/Builder.md) (more flexible, but more complicated).
- [Abstract Factory](/docs/main/CleanCode/Abstract%20Factory) classes are often based on a set of Factory Methods, but you can also use [Prototype](docs/main/CleanCode/Prototype.md) to compose the methods on these classes.
- You can use Factory Method along with [Iterator](/docs/main/CleanCode/Iterator) to let collection subclasses return different types of iterators that are compatible with the collections.
- [Prototype](/docs/main/CleanCode/Prototype) isn’t based on inheritance, so it doesn’t have its drawbacks. On the other hand, [Prototype](docs/main/CleanCode/Prototype.md) requires a complicated initialization of the cloned object. Factory Method is based on inheritance but doesn’t require an initialization step.
- Factory Method is a specialization of [Template Method](/docs/main/CleanCode/Template%20Method). At the same time, a Factory Method may serve as a step in a large [Template Method](docs/main/CleanCode/Template%20Method.md).

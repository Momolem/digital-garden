...
Bereits im [gelben Grad](docs/main/CleanCode/1.%20CleanCodeDeveloper/Grade/2.%20Gelber%20Grad.md) hat der [CCD](docs/main/CleanCode/1.%20CleanCodeDeveloper/index.md) das [Dependency Inversion Principle](docs/main/CleanCode/1.%20CleanCodeDeveloper/Prinzipien/Dependency%20Inversion%20Principle.md) kennengelernt. Dabei wurden die Abhängigkeiten noch „von Hand“ aufgelöst. Der nächste logische Schritt besteht nun darin, das Auflösen der Abhängigkeiten zu automatisieren. Dazu stehen zwei Verfahren zur Verfügung:

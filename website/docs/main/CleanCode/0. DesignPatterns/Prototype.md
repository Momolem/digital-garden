...
- Abstract [Factory](/docs/main/CleanCode/DesignPatterns/Factory) classes are often based on a set of [Factory](docs/main/CleanCode/0.%20DesignPatterns/Factory.md) Methods, but you can also use Prototype to compose the methods on these classes.
...
- [Abstract Factory](/docs/main/CleanCode/DesignPatterns/Abstract%20Factory), [Builders](docs/main/CleanCode/0.%20DesignPatterns/Builder.md) and [Prototype](docs/main/CleanCode/0.%20DesignPatterns/Prototype.md) can all be implemented as [Singleton](docs/main/CleanCode/0.%20DesignPatterns/Singleton.md).

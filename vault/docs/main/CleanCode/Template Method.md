...
| You can pull the duplicate code into a superclass. | You might violate the [Liskov Substitution Principle](docs/main/CleanCode/Liskov%20Substitution%20Principle.md) by suppressing a default step implementation via a subclass. |
| | Template methods tend to be harder to maintain the more steps they have. |

## Relations with Other Patterns
- [Factory](docs/main/CleanCode/Factory.md) Method is a specialization of Template Method. At the same time, a [Factory](docs/main/CleanCode/Factory.md) Method may serve as a step in a large Template Method.

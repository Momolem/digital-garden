...
Bereits im [gelben Grad](/docs/main/CleanCode/CleanCodeDeveloper/Grade/Gelber%20Grad) hat der [CCD](docs/main/CleanCode/CleanCodeDeveloper.md) das [Dependency Inversion Principle](docs/main/CleanCode/CleanCodeDeveloper/Prinzipien/Dependency%20Inversion%20Principle.md) kennengelernt. Dabei wurden die Abhängigkeiten noch „von Hand“ aufgelöst. Der nächste logische Schritt besteht nun darin, das Auflösen der Abhängigkeiten zu automatisieren. Dazu stehen zwei Verfahren zur Verfügung:

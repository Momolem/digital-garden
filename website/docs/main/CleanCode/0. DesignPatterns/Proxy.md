...
- [Adapter](/docs/main/CleanCode/DesignPatterns/Adapter) provides a different interface to the wrapped object, Proxy provides it with the same interface, and [Decorator](docs/main/CleanCode/0.%20DesignPatterns/Decorator.md) provides it with an enhanced interface.
- [Facade](/docs/main/CleanCode/DesignPatterns/Facade) is similar to Proxy in that both buffer a complex entity and initialize it on its own. Unlike [Facade](docs/main/CleanCode/0.%20DesignPatterns/Facade.md), Proxy has the same interface as its service object, which makes them interchangeable.
